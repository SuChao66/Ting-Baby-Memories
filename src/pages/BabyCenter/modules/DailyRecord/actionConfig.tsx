...
> = {
  [DAILY_RECORD_TYPES.FEED]: { title: "添加喂奶记录", actionText: "开始喂奶" },
  [DAILY_RECORD_TYPES.DIAPER]: {
    title: "添加换尿布记录",
    actionText: "记录换尿布",
  },
  [DAILY_RECORD_TYPES.SLEEP]: { title: "添加睡眠记录", actionText: "开始睡觉" },
  [DAILY_RECORD_TYPES.FOOD]: {
    title: "添加辅食记录",
    actionText: "开始吃辅食",
  },
  [DAILY_RECORD_TYPES.BATH]: { title: "添加洗澡记录", actionText: "开始洗澡" },
  [DAILY_RECORD_TYPES.PLAY]: { title: "添加玩耍记录", actionText: "开始玩耍" },
  [DAILY_RECORD_TYPES.SWIM]: { title: "添加游泳记录", actionText: "开始游泳" },
  [DAILY_RECORD_TYPES.OTHER]: { title: "添加其他事件", actionText: "记录事件" },
};
